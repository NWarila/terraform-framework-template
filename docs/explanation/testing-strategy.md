...
| Terraform plan policy | `make opa-plan` | `synthetic_framework_plan` and `terraform_plan` evaluate a real multi-environment `terraform plan` produced from the example fixture. |
